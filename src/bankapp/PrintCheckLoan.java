 ...
 * @author Mostafa(R-34)
 */
public class PrintCheckLoan extends javax.swing.JFrame {
...
//        System.exit(0);
    ...
    public void display(int x) {
        ...
        try {
            ...
            rs = stm.executeQuery("select account_number, name, father_name, mobile_number, loan, payment, "
                    + "month, payable from loan_managment natural join loan where account_number = '" + x + "' ");
            int ctr = 0;
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintCheckLoan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//                new NewPrint().display(3);
                new PrintCheckLoan().setVisible(true);
            }
        });
    }
