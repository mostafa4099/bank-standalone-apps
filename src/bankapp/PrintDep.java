 ...
 * @author Mostafa(R-34)
 */
public class PrintDep extends javax.swing.JFrame {
...
//        System.exit(0);
    ...
    public void display(int x) {
        ...
        try {
            ...
            rs = stm.executeQuery("select account_number, name, father_name, mother_name, mobile_number, "
                    + "balance, date, deposit from loan_managment where account_number = '" + x + "' ");
            int ctr = 0;
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintDep.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
